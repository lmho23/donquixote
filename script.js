...
const endingDialogues = [
    ...
    "하지만 아직 한 가지가 남아 있습니다.",

    "대체 왜 이런 일을 벌였던 걸까요?",

    "이 방의 기록들을 보면 니콜라스는 언제나 다른 사람들을 지나치게 의식했던 것 같습니다.",

    "누군가의 외모와 물건, 삶을 바라보며 자신에게 없는 것만을 계속 찾았던 거죠.",

    "그리고 어느 순간부터는 그 사람을 닮고 싶다는 마음이 점점 뒤틀리기 시작한 것 같습니다.",

    "그 사람이 가진 것을 빼앗고, 자신의 것으로 만들면 자신도 그들과 같은 사람이 될 수 있다고 믿었던 겁니다.",

    "그래서 사람들을 해치고, 그들이 남긴 것들을 모아왔던 거군요.",

    "하지만 아무리 다른 사람의 것을 모은다고 해도, 그 사람이 될 수는 없었을 텐데요.",

    "돈키호테는 다른 사람들이 외면했던 그 모습을 알아챘던 겁니다.",

    "그래서 계속 니콜라스의 뒤를 쫓았고, 결국 이 사건의 진실에 가장 가까이 다가갔던 거겠죠.",

    "돈키호테가 밝히려고 했던 진실은 이것이었군요.",
